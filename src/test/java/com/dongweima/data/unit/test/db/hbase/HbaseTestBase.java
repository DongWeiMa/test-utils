...
public class HbaseTestBase {
  ...
  public void testCreateTable() throws Throwable {
    ...
    HbaseTestUtil.createTable(tableName, new String[]{"families"});
    assertEquals(true, HbaseTestUtil.tableExist(tableName));
  }

  @Test
  public void testTableExist() {
    assertEquals(false, HbaseTestUtil.tableExist("hhhh"));
    assertEquals(true, HbaseTestUtil.tableExist(user_group));
  }
